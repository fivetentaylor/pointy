export const metadata = {
  title: "Pointy.ai: Legal - Terms of Service",
};
...
export default function IndexPage() {
  ...
  return (
    <div>
      ...
      <p className={pc}>
        <strong>
          <em>Date of Last Revision</em>: February 20, 2025
        </strong>
      </p>
      <p className={pc}>
        <strong>
      ...
      <p className={pc}>
        Pointy AI, Co. (“Pointy,” “we,” “us,” or “our”) provides our services
        (described below) and related content to you through our website(s)
        located at https://pointy.ai (the “Site”) and through our related
        technologies (such services and technology, and the Site, including all
        features and functionality thereof and updates thereto, collectively,
        the “Service”). All access and use of the Service is subject to the
        terms and conditions contained in these Terms of Service (as amended
        from time to time, these “Terms of Service”). By accessing, browsing, or
        otherwise using the Site or any other aspect of the Service, you
        acknowledge that you have read, understood, and agree to be bound by
        these Terms of Service. If you are entering into these Terms of Service
        on behalf of a company, business or other legal entity, you represent
        that you have the authority to bind such entity to these Terms of
        Service, in which case the terms “you” or “your” shall refer to such
        entity. If you do not have such authority and/or accept the terms and
      ...
      <p className={pc}>
        ...
        of Service” link on the Site. We will also notify you of any material
        changes, either through the Service user interface, a pop-up notice,
        email, or through other reasonable means. Your continued use of the
        Service after the date any such changes become effective constitutes
        your acceptance of the new Terms of Service. You should periodically
        visit this page to review the current Terms of Service so you are aware
        of any revisions. If you do not agree to abide by these or any future
      ...
      <p className={pc}>
        <em>
          <strong>
            ...
            (1) YOU WILL ONLY BE PERMITTED TO PURSUE CLAIMS AGAINST POINTY ON AN
      ...
      <p className={pc}>
        <strong>Your Privacy:</strong> At Pointy, we respect the privacy of our
        users. For more information please see our Privacy Policy, located at
        https://pointy.ai/pointy/legal/privacy (the “Privacy Policy”). By using
        the Service, you consent to our collection, use and disclosure of
      ...
      <p className={pc}>
        <strong>Service Description:</strong> The Service is designed to provide
        users with the ability to compose documents and edit, review, and
        collaborate using AI-based and other tools and technologies.
      </p>
      <p className={pc}>
        <strong>Your Registration Obligations:</strong> You may be required to
        register with Pointy or provide information about yourself (
        <em>e.g.</em>, name and email address) in order to access and use
        certain features of the Service. If you choose to register for the
        ...
        you are governed by our Privacy Policy. If you are under 13 years of
        age, you are not authorized to use the Service, with or without
        registering. In addition, if you are under 18 years old, you may use the
        Service, with or without registering, only with the express consent of
        your parent or guardian, and you agree to provide true, accurate,
        current, and complete information as requested by Pointy to confirm such
        express consent.
      </p>
      <p className={pc}>
        ...
        immediately notify Pointy of any unauthorized use of your password or
        ...
        Pointy will not be liable for any loss or damage arising from your
        failure to comply with this paragraph.
      </p>
      <p className={pc}>
        <strong>Modifications to Service:</strong> Pointy reserves the right to
        modify or discontinue, temporarily or permanently, the Service (or any
        part thereof) with or without notice. You agree that Pointy will not be
      ...
      <p className={pc}>
        ...
        acknowledge that Pointy may establish general practices and limits
        ...
        storage space that will be allotted on Pointy’s or its third-party
        service providers’ servers on your behalf. You agree that Pointy has no
        ...
        acknowledge that Pointy reserves the right to terminate accounts that
        are inactive for an extended period of time. You further acknowledge
        that Pointy reserves the right to change these general practices and
      ...
      <p className={pc}>
        ...
        content, text, messages, information, data, software, code, sound,
        video, images, photographs, graphics and other materials (collectively,
        “content”) that you make available to Pointy, including by uploading,
        posting, sharing, publishing, or displaying (hereinafter, “upload(ing)”)
        via the Service or by emailing or otherwise making available to other
        users of the Service (collectively, “User Content”). User Content also
        includes any other content to which you may obtain any rights in
        connection with your use of the Service. The following are examples of
        the kinds of content and/or uses that are illegal or prohibited by
        Pointy. Pointy reserves the right to investigate and take appropriate
        legal action against anyone who, in Pointy’s sole discretion, violates
        this provision, including removing the offending content from the
        Service, suspending or terminating the account of such violators, and
        reporting the violator to law enforcement authorities. You agree to not
        use the Service to:
      </p>
      <p className={pc}>
        ...
        or (vii) in the sole judgment of Pointy, is objectionable or which
        restricts or inhibits any other person from using or enjoying the
        Service, or which may expose Pointy or its users to any harm or
      ...
      <p className={pc}>
        If you are blocked by Pointy from accessing the Service (including by
      ...
      <p className={pc}>
        <strong>Competitors:</strong> No employee, independent contractor,
        agent, or affiliate of any competitor of Pointy is permitted to view,
        access, or use any portion of the Service without express written
        permission from Pointy. By viewing, using, or accessing the Service, you
        represent and warrant that you are not a competitor of Pointy, or acting
        on behalf of a competitor of Pointy in using or accessing the Service.
      </p>
      <p className={pc}>
        <strong>Fees:</strong> To the extent the Service or any portion thereof
        is made available for any fee, you may be required to select a payment
        plan and provide information regarding your credit card or other payment
        instrument. You represent and warrant to Pointy that such information is
        true and that you are authorized to use the payment instrument. You will
        promptly update your account information with Pointy or the Payment
        Processor (as defined below), as applicable, of any changes (for
        example, a change in your billing address or credit card expiration
        date) that may occur. You agree to pay Pointy the amount that is
        specified in the payment plan in accordance with the terms of such plan
        and these Terms of Service. If your payment plan includes an ongoing
        subscription that is automatically renewed periodically, you hereby
        authorize Pointy (through the Payment Processor) to bill your payment
        instrument in advance on such periodic basis in accordance with the
        terms of the applicable payment plan until you terminate your account,
        and you further agree to pay any charges so incurred. If you dispute any
        charges you must let Pointy know within sixty (60) days after the date
        that Pointy charges you, or within such longer period of time as may be
        required under applicable law. We reserve the right to change Pointy’s
        prices. If Pointy does change prices, Pointy will provide notice of the
        change through the Service user interface, a pop-up notice, email, or
        through other reasonable means, at Pointy’s option, at least thirty (30)
        ...
        taxes associated with the Service, other than taxes based on Pointy’s
        net income.
      </p>
      <p className={pc}>
        <strong>Payment Processing:</strong> Notwithstanding any amounts owed to
        Pointy hereunder, POINTY DOES NOT PROCESS PAYMENT FOR ANY SERVICES. To
        facilitate payment for the Service via bank account, credit card, or
        debit card, we may use Stripe, Inc. and its affiliates (“Stripe”) or
        other third-party payment processors (collectively, “Payment
        Processors”). These payment processing services are provided by the
        Payment Processors and are subject to, in the case of Stripe, the Stripe
        terms and conditions and other policies available at
        <a href="https://stripe.com/legal">
          <u>https://stripe.com/legal</u>
        </a>{" "}
        and Stripe’s Global Privacy Policy available at:
        <a href="https://stripe.com/privacy">
          <u>https://stripe.com/privacy</u>
        </a>
        (collectively, the &quot;Stripe Agreements&quot;) or other applicable
        Payment Processor’s terms and conditions, privacy policy, and all other
        relevant agreements (collectively, the “Payment Processor Agreements”).
        By agreeing to these Terms of Service, users that use the payment
        functions of the Service also agree to be bound by the applicable
        Payment Processor Agreement for the payment function the user is using,
        as the same may be modified by the applicable Payment Processor from
        time to time. You hereby authorize the applicable Payment Processor to
        store and continue billing your specified payment method even after such
        payment method has expired, to avoid interruptions in payment for your
        use of the Service. Please contact the applicable Payment Processor for
        more information. Pointy assumes no liability or responsibility for any
        payments you make through the Service.
      </p>
      <p className={pc}>
        <strong>Refunds and Cancellations</strong>: Payments made by you
        hereunder are final and non-refundable, unless otherwise determined by
        Pointy. You may cancel your subscription online by emailing us at:
        contact@pointy.ai
      </p>
      <p className={pc}>
        <strong>
      ...
      <p className={pc}>
        <strong>Mobile Services:</strong> The Service includes certain services
        that are available via a mobile device, including (i) the ability to
        upload content to the Service via a mobile device, (ii) the ability to
      ...
      <p className={pc}>
        <strong>Ownership; Restrictions:</strong> The technology and software
        underlying the Service or distributed in connection therewith are the
        property of Pointy, its affiliates, and its licensors (the “Software”).
      ...
      <p className={pc}>
        ...
        Pointy is headquartered in the United States. Whether inside or outside
        of the United States, you are solely responsible for ensuring compliance
        with the laws of your specific jurisdiction. Software available in
        connection with the Service and the transmission of applicable data, if
        any, is subject to United States export controls. No Software may be
        downloaded from the Service or otherwise exported or re-exported in
        violation of U.S. export laws. Downloading, accessing or using the
        Software or Services is at your sole risk.
      </p>
      <p className={pc}>
        <strong>
      ...
      <p className={pc}>
        ...
        proprietary rights and laws. Except as expressly authorized by Pointy,
        ...
        Service Content, in whole or in part, except that the foregoing does not
        apply to your own User Content (as defined below) that you upload to or
        make available through the Service in accordance with these Terms of
        Service. Any use of the Service or the Service Content other than as
        specifically authorized herein is strictly prohibited.
      </p>
      <p className={pc}>
        <strong>Trademarks:</strong> The Pointy name and logos are trademarks
        and service marks of Pointy (collectively the “Pointy Trademarks”).
        Other company, product, and service names and logos used and displayed
        via the Service may be trademarks or service marks of their respective
        owners who may or may not endorse or be affiliated with or connected to
        Pointy. Nothing in these Terms of Service or the Service should be
        construed as granting, by implication, estoppel, or otherwise, any
        license or right to use any of Pointy Trademarks displayed on the
        Service, without our prior written permission in each instance. All
        goodwill generated from the use of Pointy Trademarks will inure to our
        exclusive benefit.
      </p>
      <p className={pc}>
        <strong>Third-Party Material:</strong> Under no circumstances will
        Pointy be liable in any way for any content or materials of any third
        parties (including users), including for any errors or omissions in any
        content, or for any loss or damage of any kind incurred as a result of
        the use of any such content. You acknowledge that Pointy does not
        pre-screen content, but that Pointy and its designees will have the
        ...
        the foregoing, Pointy and its designees will have the right to remove
        any content that violates these Terms of Service or is deemed by Pointy,
        in its sole discretion, to be otherwise objectionable. You agree that
      ...
      <p className={pc}>
        <strong>User Content:</strong> You represent and warrant that you own
        all right, title and interest in and to such User Content provided by
        you, including all copyrights and rights of publicity contained therein.
        You hereby grant Pointy and its affiliates, successors and assigns a
        ...
        distribute, store, modify, and otherwise use User Content, in any form,
        medium or technology now known or later developed, (a) in connection
        with the operation of the Service, (b) to develop and improve the
        Service and other Pointy offerings, and (c) as otherwise set forth in
        our Privacy Policy. You assume all risk associated with your User
      ...
      <p className={pc}>
        You hereby authorize Pointy and its third-party service providers to
        collect and analyze User Content and other data and information relating
        to the Service and related systems and technologies and derive
        statistical and usage data relating thereto (collectively, “Usage
      ...
      <p className={pc}>
        ...
        information about the Service (“Submissions”), provided by you to Pointy
        are non-confidential and Pointy will be entitled to the unrestricted use
        and dissemination of these Submissions for any purpose, commercial or
        otherwise, without acknowledgment, attribution, or compensation to you.
      </p>
      <p className={pc}>
        You acknowledge and agree that Pointy may preserve User Content and may
        ...
        protect the rights, property, or personal safety of Pointy, its users,
        or the public. You understand that the technical processing and
      ...
      <p className={pc}>
        <strong>Generated Output</strong>: Certain features of the Service
        permit you to provide User Content (including prompts or other input
        (collectively, “Input”)) in order to receive output generated by an
        artificial intelligence platform or tool and returned by the Service
        based on such Input (“Output”). You agree not to state or suggest that
        Output was human-generated when it is not. The Service is not intended
        to be used, and you agree not to use, or permit any third party to use,
        the Service to generate any Output, for:
      </p>
      <blockquote>
        <p className={pc}>● any illegal activity;</p>
        <p className={pc}>
        ...
        <p className={pc}>● generation of viruses or malware;</p>
        <p className={pc}>
        ...
        <p className={pc}>● fraudulent or deceptive activity;</p>
        <p className={pc}>● adult content, adult industries or dating apps;</p>
        <p className={pc}>● political campaigning or lobbying;</p>
        <p className={pc}>● activity that violates people’s privacy;</p>
        <p className={pc}>
          ● unauthorized practice of law or offering tailored legal advice
          without a qualified person’s review;
        </p>
        <p className={pc}>● offering tailored financial advice;</p>
        <p className={pc}>
          ● diagnosing a certain health condition, or providing treatment
          instructions; providing diagnostic or treatment services for serious
          medical conditions; triaging or managing life-threatening issues that
          need immediate attention; or
        </p>
        <p className={pc}>● high risk decision-making.</p>
      </blockquote>
      <p className={pc}>
        In addition, you will comply with any third party terms, guidelines,
        policies or the like to which we link in connection with your generation
        of Output.
      </p>
      <p className={pc}>
        <strong>Ownership of Input and Output</strong>: As between you and us,
        and to the extent permitted by applicable law, you own all Input and,
        subject to your compliance with these Terms of Service and solely to the
        extent we obtain any ownership in any copyrights in your Output, we
        hereby assign to you our ownership interest in such copyrights to your
        Output. You are responsible for all Input and Output, including for
        ensuring that it does not violate any applicable law or these Terms of
        Service. Your Input and Output is deemed to be part of your User Content
        for purposes of these Terms of Service.
      </p>
      <p className={pc}>
        <strong>Similarity of Output</strong>: Due to the nature of automated
        content generation, Output may not be unique across users and the
        Service may generate the same or similar output for you, Pointy or a
        third party. Other users may also provide similar Input and receive the
        same or similar Output. Content generated for other users are not
        considered your Output. You hereby irrevocably release, acquit and
        forever discharge, and agree not to sue, Pointy or any of its
        affiliates, or any of their employees, officers, directors or
        representatives with respect to any liability for direct or indirect
        copyright, trademark or other infringement, misappropriation or
        violation of any rights with respect to Output.
      </p>
      <p className={pc}>
        <strong>Accuracy</strong>: Use of the Service may in some situations
        result in incorrect Output that does not accurately reflect real people,
        places or facts. You agree to evaluate and be responsible for the
        accuracy of any Output as appropriate for your use case.
      </p>
      <p className={pc}>
        <strong>Limitations of AI-Generated Output</strong>: You acknowledge and
        agree that, in addition to the limitations and restrictions set forth in
        these Terms of Service, there are numerous limitations that apply with
        respect to AI-generated Output due to the fact that it is automatically
        generated, including that (a) it may contain errors or misleading
        information, (b) AI systems are based on predefined rules and algorithms
        that lack the ability to think creatively and come up with new ideas and
        can result in repetitive or formulaic content, (c) AI systems can
        struggle with understanding the nuances of language, including slang,
        idioms, and cultural references, which can result in Output that is out
        of context or does not make sense, (d) AI systems do not have emotions
        and cannot understand or convey emotions in the way humans can, which
        can result in Output that lacks the empathy and emotion that humans are
        able to convey, (e) AI systems can perpetuate biases that are present in
        the data used to train them, which can result in Output that is
        discriminatory or offensive, (f) AI systems can struggle with complex
        tasks that require reasoning, judgment and decision-making, (g) AI
        systems require large amounts of data to train and generate content, and
        the data used to train AI systems may be of poor quality or biased,
        which will negatively impact the accuracy and quality of the generated
        Output, and (h) AI-generated Output can lack the personal touch that
        comes with content created by humans, which can make it seem cold and
        impersonal.
      </p>
      <p className={pc}>
        <strong>Copyright Complaints:</strong> Pointy respects the intellectual
        ...
        otherwise violated, you should notify Pointy of your infringement claim
        in accordance with the procedure set forth below.
      </p>
      <p className={pc}>
        Pointy will process and investigate notices of alleged infringement and
        ...
        infringement should be emailed to Pointy’s Copyright Agent at
        contact@pointy.ai (Subject line: “DMCA Takedown Request”). You may also
        contact the Copyright Agent by mail or facsimile at:
      </p>
      <p className={pc}>390 NE 191st St STE 8190 Miami, FL 33179</p>
      <p className={pc}>
      ...
      <p className={pc}>your address, telephone number, and email address;</p>
      <p className={pc}>
      ...
      <p className={pc}>
        ...
        property owner or are authorized to act on the behalf of the owner of
        the copyright or intellectual property that is allegedly infringed.
      </p>
      <p className={pc}>
        <em>
        ...
        pursuant to the law, to upload and use the content in your User Content,
      ...
      <p className={pc}>
        ...
        disabled; a statement by you, made under penalty of perjury, that you
        have a good faith belief that the content was removed or disabled as a
        result of mistake or a misidentification of the content to be removed or
        disabled; and your name, address, telephone number, and email address, a
        statement that you consent to the jurisdiction of the federal court
        located within the District of Delaware and a statement that you will
        accept service of process from the person who provided notification of
        the alleged infringement.
      </p>
      <p className={pc}>
        If a counter-notice is received by the Copyright Agent, Pointy will send
        a copy of the counter-notice to the original complaining party informing
        them that Pointy may replace the removed content or cease disabling it
        within ten (10) business days. Unless the owner of the applicable
        copyrighted work or other intellectual property files an action seeking
        a court order against Pointy or the user, the removed content may be
      ...
      <p className={pc}>
        ...
        : In accordance with the DMCA and other applicable law, Pointy has
        adopted a policy of terminating, in appropriate circumstances and at
        Pointy’s sole discretion, the accounts of users who are deemed to be
        repeat infringers. Pointy may also at its sole discretion limit access
      ...
      <p className={pc}>
        ...
        by third parties (the “Third-Party Services”). Your access and use of
        the Third-Party Services may also be subject to additional terms and
        conditions, privacy policies, or other agreements with such third party,
        and you may be required to authenticate to or create separate accounts
        to use Third-Party Services on the websites or via the technology
        platforms of their respective providers. Some Third-Party Services will
        provide us with access to certain information that you have provided to
        third parties, including through such Third-Party Services, and we will
        use, store and disclose such information in accordance with our Privacy
        ...
        Service, please see our Privacy Policy. Pointy has no control over and
        ...
        prior to using such services. You, and not Pointy, will be responsible
        for any and all costs and charges associated with your use of any
        Third-Party Services. Pointy enables these Third-Party Services merely
        as a convenience and the integration or inclusion of such Third-Party
        Services does not imply an endorsement or recommendation. Any dealings
        you have with third parties while using the Service are between you and
        the third party. Pointy will not be responsible or liable, directly or
        indirectly, for any damage or loss caused or alleged to be caused by or
        in connection with use of or reliance on any Third-Party Services.
      </p>
      <p className={pc}>
        <strong>
          <u>Indemnification</u>
      ...
      <p className={pc}>
        ...
        indemnify, and hold harmless Pointy, its affiliates, and its and their
        respective officers, employees, directors, service providers, licensors,
        and agents (collectively, the “Pointy Parties”) from any and all losses,
        damages, expenses, including reasonable attorneys’ fees, rights, claims,
        actions of any kind, and injury (including death) arising out of or
        relating to your use of the Service, any User Content, your connection
        to the Service, your violation of these Terms of Service, or your
        violation of any rights of another. Pointy will provide notice to you of
        any such claim, suit, or proceeding. Pointy reserves the right to assume
        ...
        reasonable requests assisting Pointy’s defense of such matter. You may
        not settle or compromise any claim against the Pointy Parties without
        Pointy’s written consent.
      </p>
      <p className={pc}>
        <strong>
      ...
      <p className={pc}>
        ...
        AN “AS IS” AND “AS AVAILABLE” BASIS. THE POINTY PARTIES EXPRESSLY
      ...
      <p className={pc}>
        THE POINTY PARTIES MAKE NO WARRANTY THAT (A) THE SERVICE WILL MEET YOUR
        ...
        SERVICE WILL BE ACCURATE OR RELIABLE; OR (D) THE QUALITY OF ANY
      ...
      <p className={pc}>
        YOU EXPRESSLY UNDERSTAND AND AGREE THAT THE POINTY PARTIES WILL NOT BE
        ...
        GOODWILL, USE, OR DATA OR OTHER INTANGIBLE LOSSES (EVEN IF THE POINTY
        ...
        OTHER MATTER RELATING TO THE SERVICE. IN NO EVENT WILL THE POINTY
        PARTIES’ TOTAL LIABILITY TO YOU FOR ALL DAMAGES, LOSSES, OR CAUSES OF
        ACTION EXCEED THE AMOUNT YOU HAVE PAID POINTY IN THE LAST SIX (6)
      ...
      <p className={pc}>
        ...
        and Pointy, whether arising out of or relating to these Terms of Service
        ...
        local agencies, and such agencies can, if the law allows, seek relief
        against us on your behalf. You agree that, by entering into these Terms
        of Service, you and Pointy are each waiving the right to a trial by jury
        or to participate in a class action. Your rights will be determined by a
      ...
      <p className={pc}>
        <em>
          <strong>
            YOU AND POINTY AGREE THAT EACH OF US MAY BRING CLAIMS AGAINST THE
            ...
            PROCEEDING. UNLESS BOTH YOU AND POINTY AGREE OTHERWISE, THE
      ...
      <p className={pc}>
        Pointy is always interested in resolving disputes amicably and
        ...
        contact@pointy.ai. If such efforts prove unsuccessful, a party who
        intends to seek arbitration must first send to the other, by certified
        mail, a written Notice of Dispute (“Notice”). The Notice to Pointy
        should be sent to contact@pointy.ai (“Notice Address”). The Notice must
        (i) describe the nature and basis of the claim or dispute and (ii) set
        forth the specific relief sought. If Pointy and you do not resolve the
        claim within sixty (60) calendar days after the Notice is received, you
        or Pointy may commence an arbitration proceeding. During the
        arbitration, the amount of any settlement offer made by Pointy or you
        will not be disclosed to the arbitrator until after the arbitrator
        determines the amount, if any, to which you or Pointy is entitled.
      </p>
      <p className={pc}>
      ...
      <p className={pc}>
        ...
        <a href="https://www.adr.org/consumer">
          <u>https://www.adr.org/consumer</u>
        </a>
      ...
      <p className={pc}>
        Unless Pointy and you agree otherwise, any arbitration hearings will
        ...
        Pointy agrees that you may choose whether the arbitration will be
      ...
      <p className={pc}>
        ...
        Pointy or you under the AAA Rules, Pointy and you shall split them
        equally; provided that if you are able to demonstrate to the arbitrator
        that you are economically unable to pay your portion of such Arbitration
        Fees or if the arbitrator otherwise determines for any reason that you
        should not be required to pay your portion of any Arbitration Fees,
        Pointy will pay your portion of such fees. In addition, if you
        demonstrate to the arbitrator that the costs of arbitration will be
        prohibitive as compared to the costs of litigation, Pointy will pay as
      ...
      <p className={pc}>
        ...
        Pointy agrees that if it makes any future change to this Arbitration
        Agreement (other than a change to the Notice Address) while you are a
        user of the Service, you may reject any such change by sending Pointy
        ...
        with the language of this Arbitration Agreement as of the date you first
      ...
      <p className={pc}>
        You agree that Pointy, in its sole discretion, may suspend or terminate
        your account (or any part thereof) or use of the Service and remove and
        discard any content within the Service, for any reason, including for
        lack of use or if Pointy believes that you have violated or acted
        ...
        appropriate law enforcement authorities. Pointy may also in its sole
        ...
        your access to the Service under any provision of these Terms of Service
        may be effected without prior notice, and acknowledge and agree that
        Pointy may immediately deactivate or delete your account and all related
        information and files in your account and/or bar any further access to
        such files or the Service. Further, you agree that Pointy will not be
      ...
      <p className={pc}>
        ...
        other user in connection with the Service, and Pointy will have no
        liability or responsibility with respect thereto. Pointy reserves the
      ...
      <p className={pc}>
        ...
        reference herein) constitute the entire agreement between you and Pointy
        governing your access and use of the Service, and supersede any prior
        agreements between you and Pointy with respect to the Service. You also
        may be subject to additional terms and conditions that may apply when
        you use Third-Party Services, third-party content or third-party
        software. These Terms of Service will be governed by the laws of the
        State of Delaware without regard to its conflict of law provisions. With
        respect to any disputes or claims not subject to arbitration, as set
        forth above, you and Pointy submit to the personal and exclusive
        jurisdiction of the state and federal courts located within New Castle
        County, Delaware. The failure of Pointy to exercise or enforce any right
        or provision of these Terms of Service will not constitute a waiver of
        ...
        or these Terms of Service must be filed within one (1) year after such
        claim or cause of action arose or be forever barred. A printed version
        of these Terms of Service and of any notice given in electronic form
        will be admissible in judicial or administrative proceedings based upon
        or relating to these Terms of Service to the same extent and subject to
        ...
        of Service without the prior written consent of Pointy, but Pointy may
        ...
        Service. Pointy will not be in default hereunder by reason of any
        ...
        beyond Pointy’s reasonable control.
      </p>
      <p className={pc}>
        <strong>
      ...
      <p className={pc}>
        ...
        <a href="mailto:dca@dca.ca.gov">
          <u>dca@dca.ca.gov</u>
        </a>
        ; (b) in writing at: Department of Consumer Affairs, Consumer
        Information Division, 1625 North Market Blvd., Suite N 112, Sacramento,
        CA 95834; or (c) by telephone at (800) 952-5210 or (800) 326-2297 (TDD).
        Sacramento-area consumers may call (916) 445-1254 or (916) 928-1227
        (TDD). You may contact us at Pointy AI, Co.
        <em>3025 NE 205th St, Lake Forest Park, Wa 98155</em>.
      </p>
      <p className={pc}>
        <strong>
      ...
      <p className={pc}>
        Please contact us at contact@pointy.ai to report any violations of these
        Terms of Service or to pose any questions regarding these Terms of
