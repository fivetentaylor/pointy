...
func newComment(db *gorm.DB, opts ...gen.DOOption) comment {
	...
	_comment.DocumentID = field.NewString(tableName, "document_id")
	_comment.ThreadID = field.NewString(tableName, "thread_id")
	...
	_comment.Selection = field.NewString(tableName, "selection")
	_comment.SelectionStart = field.NewString(tableName, "selection_start")
	_comment.SelectionFinish = field.NewString(tableName, "selection_finish")
	_comment.Notes = field.NewString(tableName, "notes")
...
type comment struct {
	...
	SelectionStart  field.String
	SelectionFinish field.String
	Notes           field.String
...
func (c *comment) updateTableName(table string) *comment {
	...
	c.ThreadID = field.NewString(table, "thread_id")
	c.CreatedAt = field.NewTime(table, "created_at")
	c.UpdatedAt = field.NewTime(table, "updated_at")
	c.DeletedAt = field.NewField(table, "deleted_at")
	c.UserID = field.NewString(table, "user_id")
	c.Body = field.NewString(table, "body")
	c.Selection = field.NewString(table, "selection")
	c.SelectionStart = field.NewString(table, "selection_start")
	c.SelectionFinish = field.NewString(table, "selection_finish")
...
func (c *comment) fillFieldMap() {
	...
	c.fieldMap["thread_id"] = c.ThreadID
	c.fieldMap["created_at"] = c.CreatedAt
	c.fieldMap["updated_at"] = c.UpdatedAt
	c.fieldMap["deleted_at"] = c.DeletedAt
	c.fieldMap["user_id"] = c.UserID
	c.fieldMap["body"] = c.Body
	c.fieldMap["selection"] = c.Selection
	c.fieldMap["selection_start"] = c.SelectionStart
	c.fieldMap["selection_finish"] = c.SelectionFinish
