...
func newDocument(db *gorm.DB, opts ...gen.DOOption) document {
	...
	_document.ParentID = field.NewString(tableName, "parent_id")
	_document.DeletedAt = field.NewField(tableName, "deleted_at")
	_document.IsPublic = field.NewBool(tableName, "is_public")
	_document.RogueVersion = field.NewString(tableName, "rogue_version")
	_document.RootParentID = field.NewString(tableName, "root_parent_id")
	_document.ParentAddress = field.NewString(tableName, "parent_address")
	_document.IsFolder = field.NewBool(tableName, "is_folder")
	_document.FolderID = field.NewString(tableName, "folder_id")
...
type document struct {
	...
	IsPublic      field.Bool
	RogueVersion  field.String
	RootParentID  field.String
	ParentAddress field.String
	IsFolder      field.Bool
...
func (d *document) updateTableName(table string) *document {
	...
	d.RogueVersion = field.NewString(table, "rogue_version")
	d.RootParentID = field.NewString(table, "root_parent_id")
	d.ParentAddress = field.NewString(table, "parent_address")
	d.IsFolder = field.NewBool(table, "is_folder")
	d.FolderID = field.NewString(table, "folder_id")
...
func (d *document) fillFieldMap() {
	...
	d.fieldMap["rogue_version"] = d.RogueVersion
	d.fieldMap["root_parent_id"] = d.RootParentID
	d.fieldMap["parent_address"] = d.ParentAddress
	d.fieldMap["is_folder"] = d.IsFolder
	d.fieldMap["folder_id"] = d.FolderID
}
